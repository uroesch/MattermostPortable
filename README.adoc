...
:author: Urs Roesch
:app-name-spaced: Mattermost
:app-name: MattermostPortable
:git-user: uroesch
...
{upstream-url}[{app-name-spaced}] is an open-source, self-hostable online chat
service with file sharing, search, and integrations. It is designed as an
internal chat for organisations and companies, and mostly markets itself as an
...
[NOTE] 
With the release of the 5.x version of {app-name-spaced} quite a few things
have changed and the application does not work fully as a PortableApp anymore.
